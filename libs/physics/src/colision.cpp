...
math::coords_t Collision::get_pos() {
...
bool RestangleCollision::check_collision(const Collision &collision) {
    return false;
}
...
bool TriangleCollision::check_collision(const Collision &collision) {
    return false;
}
...
bool CircleCollision::check_collision(const Collision &collision) {
    return false;
}
