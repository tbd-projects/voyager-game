...
FileError::FileError(const std::string_view &filename,
                     const std::string_view &classname,
                     const std::string_view &methodname,
                     const std::string_view &arg) :
