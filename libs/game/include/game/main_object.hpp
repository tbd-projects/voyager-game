...
public:
    ...
    explicit GameObject(size_t sprite_id,Sprite* sprite, std::unique_ptr<math::Polygon> &&pol,
    ...
    void set_sprite(Sprite *sprite) override;
...
public:
    ...
    explicit NotActiveObject(size_t sprite_id,Sprite* sprite, std::unique_ptr<math::Polygon> &&pol,
